...
<body class="bg-gray-50 text-gray-800">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <a href="{{ route('wishlist.index') }}" class="relative inline-flex items-center p-2 rounded-full transition-transform duration-300 hover:scale-110">
    ...
    <div class="bg-white border-b border-purple-50">
        <div class="container mx-auto px-4 py-3">
            <div class="flex space-x-12 justify-center">
                @foreach ($categories as $category)
                    <a href="#"
                        class="text-gray-600 hover:text-purple-600 transition-colors duration-200 font-medium">
                                    ...
                                    @if (Auth::user())
                                        <div
                                            ...
                                            <form action="{{ route('wishlist.store') }}" method="POST">
                                                ...
                                                <button type="submit" 
                                                    class="bg-purple-600 hover:bg-purple-700 text-white p-3 rounded-md shadow-lg hover:scale-105 transition-all duration-200">
        ...
        <section class="py-16 bg-purple-50/50">
            <div class="container mx-auto px-4">
                <h2 class="text-2xl font-light text-gray-800 mb-10">Shop by <span
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    @foreach ($categories as $cat)
                        <div
                            ...
                            <h3 class="font-medium text-gray-700">{{ $cat->category_name }}</h3>
                        </div>
                    @endforeach
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div>
                        ...
                        <ul class="space-y-4">
                            ...
                            <li><a href="#"
                                    class="hover:text-purple-600 transition-colors duration-200">Creator</a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-purple-600 transition-colors duration-200">Github</a>
                            </li>
                        </ul>
                    </div>
                    <div>
