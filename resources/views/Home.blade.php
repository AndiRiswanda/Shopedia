...
<nav class="bg-white shadow-sm">
    <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
            <!-- Logo -->
            <div class="logo">
                <img src="{!! asset('images/Shopedia Text Logo/4x/Layer 1@4x.png') !!}" alt="Shopedia Logo" class="h-12 transition-transform duration-300 hover:scale-115">
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    @foreach ($products as $product)
                        <div
                            ...
                            <div class="relative">
                                <img src="{{ $product->productImages->isEmpty() ? 'https://karanzi.websites.co.in/obaju-turquoise/img/product-placeholder.png' : asset($product->productImages->first()->image_url) }}" alt="{{ $product->product_name }}">
    ...
    <section class="py-16 bg-purple-50/50">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-light text-gray-800 mb-10">Shop by <span class="font-semibold">Category</span></h2>
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                @foreach (['Electronics', 'Fashion', 'Home', 'Beauty', 'Sports', 'Books'] as $category)
                    <div class="category-card bg-white rounded-xl p-6 text-center elegant-shadow cursor-pointer transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                        <div class="w-16 h-16 mx-auto mb-4 bg-purple-50 rounded-full flex items-center justify-center transition-colors duration-300 hover:bg-purple-100">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="#" class="hover:text-purple-600 transition-colors duration-200">About Us</a>
                        </li>
